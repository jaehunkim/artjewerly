-- Seed artworks from leapofeveryday.com (Playwright crawl, safe filenames)
-- Generated: 2026-03-18 v5
...
-- Tab 0: 포자들 4 Spores 4
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '포자들 4 Spores 4', 'Spores 4', '목걸이 Necklace. 레진, 유리 구슬, 정은 Resin, Glass beads, Sterling Silver. 길이 Length 88cm. 2021', '목걸이 Necklace. 레진, 유리 구슬, 정은 Resin, Glass beads, Sterling Silver. 길이 Length 88cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
...
SELECT gen_random_uuid(), id, 'local/08_Spores-4_Hee-ang-Kim.c42fc92f.jpg',
  ...
  '포자들 4 Spores 4', 'Spores 4', 0
FROM new_product;

-- Tab 0: 포자들 2 Spores 2
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '포자들 2 Spores 2', 'Spores 2', '브로치 Brooch. 나무, 레진, 플로킹 파우더, 정은 Wood, Resin, Flocking powder, Sterling Silver. 6x7.8x4.5cm. 2021', '브로치 Brooch. 나무, 레진, 플로킹 파우더, 정은 Wood, Resin, Flocking powder, Sterling Silver. 6x7.8x4.5cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/08_Spore-2-Hee-ang-Kim.8ef8d6cb.jpg',
  ...
  '포자들 2 Spores 2', 'Spores 2', 0
FROM new_product;

-- Tab 0: 포자들 1 Spores 1
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '포자들 1 Spores 1', 'Spores 1', '브로치 Brooch. 나무, 레진, 플로킹 파우더, 정은 Wood, Resin, Flocking powder, Sterling Silver. 6.5x8.8x4.6cm. 2021', '브로치 Brooch. 나무, 레진, 플로킹 파우더, 정은 Wood, Resin, Flocking powder, Sterling Silver. 6.5x8.8x4.6cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/08_Spore-1_Hee-ang-Kim.18c100f1.jpg',
  ...
  '포자들 1 Spores 1', 'Spores 1', 0
FROM new_product;

-- Tab 0: 포자들 3 Spores 3
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '포자들 3 Spores 3', 'Spores 3', '브로치 Brooch. 나무, 레진, 폴리머 클레이, 아크릴 페인트, 정은 Wood, Resin, Polymer clay, Acrylic paint, Sterling silver. 5.5x8.2x5.3cm. 2021', '브로치 Brooch. 나무, 레진, 폴리머 클레이, 아크릴 페인트, 정은 Wood, Resin, Polymer clay, Acrylic paint, Sterling silver. 5.5x8.2x5.3cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
...
SELECT gen_random_uuid(), id, 'local/08_Re-form-6_Hee-ang-Kim.47ea5d3d.jpg',
  ...
  '재구성된 형태 6 Re-form 6', 'Re-form 6', 0
FROM new_product;
...
SELECT gen_random_uuid(), id, 'local/07_Re-form-3_Hee-ang-Kim.f2c6862c.jpg',
  ...
  '재구성된 형태 3 Re-form 3', 'Re-form 3', 0
FROM new_product;
...
-- Tab 3: 피고 지다 9 Bloom and Wither 9
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '피고 지다 9 Bloom and Wither 9', 'Bloom and Wither 9', '브로치 Brooch. 정은에 착색, 석분점토, 레진, 아크릴 페인트 Sterling silver, Stone clay, Resin, Acrylic paint. 10.1x15.2x6.4cm. 2019', '브로치 Brooch. 정은에 착색, 석분점토, 레진, 아크릴 페인트 Sterling silver, Stone clay, Resin, Acrylic paint. 10.1x15.2x6.4cm. 2019', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/05_Bloom-and-Wither-9_Hee-ang-Kim.c047198d.jpg',
  ...
  '피고 지다 9 Bloom and Wither 9', 'Bloom and Wither 9', 0
FROM new_product;

-- Tab 3: 피고 지다 11 Bloom and Wither 11
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '피고 지다 11 Bloom and Wither 11', 'Bloom and Wither 11', '브로치 Brooch. 2019. 정은, 석분점토, 레진, 엠보싱 파우더 Sterling silver, Stone clay, Resin, Embossing powder', '브로치 Brooch. 2019. 정은, 석분점토, 레진, 엠보싱 파우더 Sterling silver, Stone clay, Resin, Embossing powder', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/05_Bloom-and-Wither-11_Hee-ang-Kim.959ee145.jpg',
  ...
  '피고 지다 11 Bloom and Wither 11', 'Bloom and Wither 11', 0
FROM new_product;

-- Tab 3: 피어나다 7 Blooming 7
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '피어나다 7 Blooming 7', 'Blooming 7', '브로치 Brooch. 정은, 석분점토, 폴리머 클레이 Sterling silver, Stone clay, Polymer clay. 10.2x12.1x4.5cm. 2019', '브로치 Brooch. 정은, 석분점토, 폴리머 클레이 Sterling silver, Stone clay, Polymer clay. 10.2x12.1x4.5cm. 2019', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/05_Blooming-7_Hee-ang-Kim.40018bdc.jpg',
  ...
  '피어나다 7 Blooming 7', 'Blooming 7', 0
FROM new_product;

-- Tab 3: 재구성된 형태 2 Re-form 2
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '재구성된 형태 2 Re-form 2', 'Re-form 2', '브로치 Brooch. 폴리머클레이, 석분점토,정은, 아크릴 페인트 Polymer clay, Stone clay, Sterling silver, Acrylic paint. 5.1x7x3.2cm. 2021', '브로치 Brooch. 폴리머클레이, 석분점토,정은, 아크릴 페인트 Polymer clay, Stone clay, Sterling silver, Acrylic paint. 5.1x7x3.2cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/05_Heart-brooch_Hee-ang-Kim.7cc067bb.jpg',
  ...
  '재구성된 형태 2 Re-form 2', 'Re-form 2', 0
FROM new_product;

-- Tab 3: 시작점 Starting point
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
...
-- Tab 3: 재구성된 형태 1 Re-form 1
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '재구성된 형태 1 Re-form 1', 'Re-form 1', '브로치 Brooch. 폴리머클레이, 석분점토,정은, 아크릴 페인트 Polymer clay, Stone clay, Sterling silver, Acrylic paint. 7.2x6.5x4.5cm. 2021', '브로치 Brooch. 폴리머클레이, 석분점토,정은, 아크릴 페인트 Polymer clay, Stone clay, Sterling silver, Acrylic paint. 7.2x6.5x4.5cm. 2021', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/05_Re-form-1-_Hee-ang-Kim.4315a2c0.jpg',
  ...
  '재구성된 형태 1 Re-form 1', 'Re-form 1', 0
FROM new_product;
...
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/03_M-Pin-3_4.7a93563b.jpeg',
  '{"thumbnail": "/images/artworks/03_M-Pin-3_4.7a93563b.jpeg", "medium": "/images/artworks/03_M-Pin-3_4.7a93563b.jpeg", "large": "/images/artworks/03_M-Pin-3_4.7a93563b.jpeg", "blur": "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAFCAYAAABirU3bAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAP0lEQVR4nGNgYPj/n4EBCBgZGf8zMDL+Z2Bk/M/AxPCfgZHhPwMjE8N/BkYmhv8MTMwMIJaAJIAsAUkAAQYAVKoMY1l8tycAAAAASUVORK5CYII="}'::jsonb,
  'M pin 4', 'M pin 4', 0
FROM new_product;

-- Tab 5: Mboutonniere 6, 7
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
...
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/03_Mboutonniere-6_-7.f8889469.JPG',
  '{"thumbnail": "/images/artworks/03_Mboutonniere-6_-7.f8889469.JPG", "medium": "/images/artworks/03_Mboutonniere-6_-7.f8889469.JPG", "large": "/images/artworks/03_Mboutonniere-6_-7.f8889469.JPG", "blur": "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAQAAAAFCAYAAABirU3bAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAP0lEQVR4nGNgYPj/n4EBCBgZGf8zMDL+Z2Bk/M/AxPCfgZHhPwMjE8N/BkYmhv8MTMwMIJaAJIAsAUkAAQYAVKoMY1l8tycAAAAASUVORK5CYII="}'::jsonb,
...
-- Tab 5: 버섯 귀걸이 대 Mushroom earrings L
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
...
SELECT gen_random_uuid(), id, 'local/01_Re-form-4_Hee-ang-Kim.c0046ff6.jpg',
  ...
  '재구성된 형태 4 Re-form 4', 'Re-form 4', 0
FROM new_product;

-- Tab 7: 군집 9 Cluster 9
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '군집 9 Cluster 9', 'Cluster 9', '브로치 Brooch. 폴리머클레이, 아크릴 물감, 정은, 알루미늄, Polymer clay, Acrylic paint, Sterling silver, Aluminium. 9x12x3.5cm. 2018', '브로치 Brooch. 폴리머클레이, 아크릴 물감, 정은, 알루미늄, Polymer clay, Acrylic paint, Sterling silver, Aluminium. 9x12x3.5cm. 2018', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
SELECT gen_random_uuid(), id, 'local/01_Cluster-9_Hee-ang-Kim.b7e5c368.jpg',
  ...
  '군집 9 Cluster 9', 'Cluster 9', 0
FROM new_product;

-- Tab 7: 군집 17 Cluster 17
WITH new_product AS (
  INSERT INTO products (id, category, title_ko, title_en, description_ko, description_en, price, price_usd, currency, is_available)
  VALUES (gen_random_uuid(), 'art', '군집 17 Cluster 17', 'Cluster 17', '브로치 Brooch. 폴리머클레이, 아크릴 물감, 정은, Polymer clay, Acrylic paint, Sterling silver. 7.2x9.8x2.2cm. 2020', '브로치 Brooch. 폴리머클레이, 아크릴 물감, 정은, Polymer clay, Acrylic paint, Sterling silver. 7.2x9.8x2.2cm. 2020', NULL, NULL, 'KRW', true)
  RETURNING id
)
INSERT INTO images (id, product_id, r2_key, variants, alt_ko, alt_en, sort_order)
